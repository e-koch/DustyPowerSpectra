...
do_fitpspec_conv = False

do_makepspec_m31 = False
do_fitpspec_m31 = True
...
if do_makepspec_m31:
    ...
    pspec = PowerSpectrum(hdu[0], distance=744 * u.kpc)
...
if do_fitpspec_m31:
    ...
    print(out)
    # [array([ 8.1317742 ,  2.66411133, -5.60587055]),
    # array([0.14438586, 0.11757815, 9.23922508])]

    row_names.append('m31')
    ...
    df = pd.DataFrame(fit_results, index=row_names)
    df.to_csv(osjoin(data_path, "M31_HI", "pspec_hi_m31_fit_results.csv"))
